...
# Database: kumulus
# Generation Time: 2014-01-28 09:41:10 +0000
# ************************************************************
...
CREATE TABLE `document` (
  ...
  KEY `FK335CD11B5AEDB178` (`document_type_id`),
  CONSTRAINT `FK335CD11B5AEDB178` FOREIGN KEY (`document_type_id`) REFERENCES `document_type` (`id`),
