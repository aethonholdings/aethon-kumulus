...
# Database: kumulus
# Generation Time: 2014-01-21 09:50:25 +0000
# ************************************************************
...
CREATE TABLE `file` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK2FF57C4D5E1553` (`project_id`),
  CONSTRAINT `FK2FF57C4D5E1553` FOREIGN KEY (`project_id`) REFERENCES `project` (`project_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
