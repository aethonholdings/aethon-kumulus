...
public class GeneralTextFieldPhyInv
    ...
    java.awt.event.KeyListener
{
   ...
   * Max
   */
	private static Logger log = Logger.getLogger(GeneralTextFieldPhyInv.class);//For Log4j	
  private int iMax = 0 ;
  public int getMax ()
  {
    return iMax ;
  ...
  public void setTextCaseDocument ( int aTextCase , int aTextType )
  {
    ...
    setDocument ( new GeneralDocumentPhyInv ( iMin , iMax , aTextCase ,
                                              aTextType ) ) ;
  ...
  public GeneralTextFieldPhyInv ()
  {
    this ( 0 , 0 , AS_TYPED , true , MIXED ) ;
  }

  public GeneralTextFieldPhyInv ( boolean aNotNullFlag )
  {
    this ( 0 , 0 , AS_TYPED , aNotNullFlag , MIXED ) ;
  }

  public GeneralTextFieldPhyInv ( int aTextCase )
  {
    this ( 0 , 0 , aTextCase , true , MIXED ) ;
  }

  public GeneralTextFieldPhyInv ( int aMin , int aMax )
  {
    this ( aMin , aMax , AS_TYPED , true , MIXED ) ;
  }

  public GeneralTextFieldPhyInv ( int aMin , int aMax , int aTextCase ,
      ...
      extends AbstractAction
  {
    ...
    public void actionPerformed ( ActionEvent e )
    {
      try
      {
        GeneralTextFieldPhyInv.this.setText ( undoText ) ;
      }
      catch ( Exception ex )
      {
