 ...
 * File:    EdittedPasswordField
 * Author:  Anna Swinney
 * Purpose:  The purpose of the EdittedPasswordField class is to provide an extension
...
/**
 * EdittedPasswordField class is an extension
 * of JPasswordField that can exhibit additional behaviors such as 1) forcing all input
 * to upper case 2) forcing all input to lower case 3) limiting input characters to
 * numbers only 4) limiting input characters to alphabetic characters only 5) limiting
 * input to a particular number of characters, which defaults to the length of the
 * field specifiec in "columns".
 **/
public class EdittedPasswordField extends JPasswordField implements Disposable
{
   ...
   **/
  public EdittedPasswordField ( int columns )
  {
    super ( columns ) ;
  ...
  /**
   * Sets the number of columns in this EdittedPasswordField.
   * @param <em>columns</em> the number of columns
   **/
  ...
  /**
       * Sets the maximum number of characters that this EdittedPasswordField  will be
   * allowed to contain.
  ...
  /**
   * Returns the maximum number of characters that this EdittedPasswordField  will be
   * allowed to contain.
  ...
  /**
   * Returns Passwordfield to it uninitialized (blank) state
   **/
  public void clear ()
  {
    this.setText ( "" ) ;
