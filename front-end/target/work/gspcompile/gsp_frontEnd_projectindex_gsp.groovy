...
class gsp_frontEnd_projectindex_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(4)
invokeTag('projectTable','g',7,['class':("pure-table"),'width':("100%"),'projects':(projects),'controller':("project"),'action':("changeStatus"),'actionText':("Change status")],-1)
printHtmlPart(3)
})
