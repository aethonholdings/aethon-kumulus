...
invokeTag('link','g',22,['controller':("collect"),'action':("index")],2)
printHtmlPart(12)
createClosureForHtmlPart(13, 2)
invokeTag('link','g',24,['controller':("review"),'action':("index")],2)
printHtmlPart(14)
createClosureForHtmlPart(15, 2)
invokeTag('link','g',25,['controller':("extract"),'action':("index")],2)
printHtmlPart(16)
createClosureForHtmlPart(17, 2)
invokeTag('link','g',27,['controller':("access"),'action':("index")],2)
printHtmlPart(18)
...
public static final long LAST_MODIFIED = 1389866431000L
