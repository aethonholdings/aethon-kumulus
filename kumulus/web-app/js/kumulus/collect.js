$(document).ready(function(){    
    ...
    var logisticsController = new LogisticsController("#nodeActions", function(node) {
    ...
    $("#button-add").click(function(){
        ...
        parent.expand();
        nodeWorkflow.add(parent, function() { tree.reloadChildren(parent); });
    });
    ...
    $("#button-edit").click(function(){
        ...
        nodeWorkflow.update(node, function() { tree.reloadChildren(node.getParent()); });
    });
