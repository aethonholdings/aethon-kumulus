...
createTagBody(1, {->
printHtmlPart(4)
for( _it718654006 in (tasks) ) {
changeItVariable(_it718654006)
printHtmlPart(5)
...
invokeTag('link','g',19,['controller':("document"),'action':("process"),'id':(it.id)],3)
printHtmlPart(8)
}
printHtmlPart(9)
})
...
public static final long LAST_MODIFIED = 1391066847000L
