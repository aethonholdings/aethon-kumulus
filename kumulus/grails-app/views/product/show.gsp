	...
	<body>
		...
		<div id="show-product" class="content scaffold-show" role="main">
			...
			<ol class="property-list product">
				...
				<li class="fieldcontain">
					<span id="imagePath-label" class="property-label"><g:message code="product.imagePath.label" default="Image Path" /></span>
					
						<span class="property-value" aria-labelledby="imagePath-label"><g:fieldValue bean="${productInstance}" field="imagePath"/></span>
