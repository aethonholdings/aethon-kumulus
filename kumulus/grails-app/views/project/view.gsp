            ...
            <div class="pure-u-2-5">
                ...
                <div class="kumulus-container">
                    <div class="kumulus-widget-4-5">
                        <g:link controller="capture" action="collect" params='[id: "${project?.id}"]' class="pure-button kumulus-float-right kumulus-margin-top">Collect paperwork</g:link>
                    ...
                    <div class="kumulus-widget-1-5">
                        <div id="search">
                            ...
                            <g:form url='[controller: "project", action: "search"]' id="searchableForm" name="searchableForm" method="get">
                                <g:textField name="q" value="${params.q}" class="pure-input" placeholder="Enter search terms" size="50"/> 
