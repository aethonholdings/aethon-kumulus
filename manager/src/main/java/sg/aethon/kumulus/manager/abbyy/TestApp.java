package sg.aethon.kumulus.manager.abbyy;
...
public class TestApp {
	...
	public static void main(String[] args) {
		...
		restClient.applicationId = props.abbyy_appid;
		restClient.password = props.abbyy_pass;
	...
	private static boolean checkAppId() {
		String appId = props.abbyy_appid;
		String password = props.abbyy_pass;
